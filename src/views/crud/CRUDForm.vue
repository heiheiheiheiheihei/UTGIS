<template>
  ...
  >
    <el-form ref="refForm" label-width="150px" :inline="false" :model="subForm" :rules="formRules" class="pr-5">
      <el-form-item label="地点" prop="name" :rules="formRules.isNotNull" label-position="left">
        <el-input v-model="subForm.name" class="widthPx-150" placeholder="地点" />
      </el-form-item>
      <el-form-item label="图片" prop="image" :rules="formRules.isNotNull" label-position="left">
        <div class="rowSE">
      ...
      <el-form-item label="首字母" prop="letter" :rules="formRules.isNotNull" label-position="left">
        <el-input v-model="subForm.letter" maxlength="1" class="widthPx-150" placeholder="首字母" />
      </el-form-item>
