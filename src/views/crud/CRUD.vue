<template>
  <div class="scroll-y">
    ...
    <div class="mr-3 rowSS">
      ...
      <el-form ref="refsearchForm" :inline="true" class="demo-searchForm ml-2">
        <el-form-item label-width="0px" label="" prop="username" label-position="left">
          <!--  --c -->
          <el-input v-model="searchForm.location" class="widthPx-150" placeholder="地点" />
        </el-form-item>
        <el-form-item label-width="0px" label="" prop="time" label-position="left">
          <el-date-picker
            v-model="startEndArr"
            type="datetimerange"
            format="YYYY-MM-DD"
    ...
    >
      ...
      <el-table-column align="center" prop="name" label="地点" min-width="100" />
      <el-table-column align="center" prop="image" label="图片" min-width="100">
      ...
      <el-table-column align="center" prop="time" label="创建时间" width="140" />
    ...
    <el-dialog v-model="detailDialog" :title="dialogTitle" width="500px" :close-on-click-modal="false">
      <div class="detail-container rowBC">
        <div class="detail-container-item">地点：{{ detailData.location }}</div>
      </div>
      <div class="detail-container rowBC">
        <div class="detail-container-item">首字母：{{ detailData.letter }}</div>
      </div>
      <div class="detail-container rowBC">
